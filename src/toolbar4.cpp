...
#define TBBE_UNSELECT_OTHERS 99

#define TBBE_TERMINATOR 100 // terminator
...
{
//predelaj tele, da bodo imena strukture
    ...
    /*IDS_TBTT_UNSELECTOTHERS*/ {IDX_TB_UNSELECTOTHERS, 0, IDS_TBTT_UNSELECTOTHERS, CM_ACTIVEUNSELECTOTHERS, 0, 0, 0, 0, 0, NULL, NULL, NULL, "UnselectOthers"},
                          ...
                          const CSVGIcon* svgIcons, int svgIconsCount)
{
    ...
    HBITMAP hSource;
    if (resID == IDB_TOOLBAR_256) // dirty hack, it would require detection by resource type (RCDATA), or by PNG signature
...
void CMainToolBar::OnGetToolTip(LPARAM lParam)
{
    ...
    if (tbbeIndex < TBBE_TERMINATOR)
    {
        ...
        {
            CPanelWindow* activePanel = MainWindow != NULL ? MainWindow->GetActivePanel() : NULL;
